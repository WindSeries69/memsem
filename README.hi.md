...
- 🔄 **यह स्वयं को सुधारता है।** विरोधाभास पुराने तथ्य को अधिलेखित करने के
  ...
  इतिहास हमेशा रखा जाता है, महत्वपूर्ण तथ्य (≥ 0.8) सुरक्षित रहते हैं। पृष्ठभूमि
...
ईमानदारी से पढ़ें, एक स्वतंत्र समीक्षा से ([Agent Memory Atlas](https://neoneye.github.io/agent-memory-atlas/systems/memsem/)):

- **स्वचालित सुधार पथ पर कोई ताला नहीं है।** जिस मान को *फिर से पुष्ट* किया गया है (कहें, वही पुराना ट्रांसक्रिप्ट दस बार पढ़ा गया) वह लौट आता है और अपने सुधार को धुंधला कर देता है — एक साधारण सुधार तीसरी पुनः-पुष्टि पर संग्रहीत हो जाता है। केवल **एक मानव जो किसी उम्मीदवार को अस्वीकार करता है** वह एक स्थायी suppression (`memory_suppressions`) लिखता है जो उस मान को पूरी तरह अस्वीकार कर देता है। यह एक जानबूझकर ली गई स्थिति है (दोहराव साक्ष्य है) जिसकी एक वास्तविक कीमत है।
- **पिन उत्तरजीविता की रक्षा करता है, दृश्यता की नहीं।** एक पिन किया गया सुधार कभी आत्मविश्वास नहीं खोता और `memsem list` में पहले स्थान पर रहता है, लेकिन एक दोहराया गया अस्वीकृत मान फिर भी `memory_search` का शीर्ष परिणाम ले सकता है।
- **`import` गेट के पीछे लिखता है** — बैकअप बहाल करने से एक दबाया गया मान वापस स्थापित हो जाता है।
- **अस्वीकृत लेखन कोई ऑडिट पंक्ति नहीं छोड़ता**, और समीक्षित तथ्य को शुद्ध करने से उसका पाठ `memory_candidates` में रह जाता है।
- **समेकन और निष्कर्षण सुरक्षा नियम प्रॉम्प्ट हैं, कोड नहीं।**

खुरदरे किनारे, बग नहीं — प्रत्येक को [DESIGN.md](DESIGN.md) रोडमैप और खुले प्रश्नों में ट्रैक किया जाता है।
...
- [x] मल्टी-हॉप ग्राफ़ प्रसार
- [ ] स्वचालित पथ पर Write gate (supersession → suppression निर्णय)
- [ ] गेट के पीछे `import` (suppressions से परामर्श)
- [ ] अस्वीकृतियों का ऑडिट; उम्मीदवारों को साफ़ करना; कोड में समेकन नियम
